<template>
	<ul
		...
		<!-- Prew -->
		<li
			:class="{'pagination__items--disabled': isFirstPage}"
		...
		<li v-if="isEmpty" class="pagination__items">...</li>
		...
		<!-- Next -->
		<li
			:class="{'pagination__items--disabled': isLastPage}"
			class="pagination__items">
			<button
				@click="nextPage()"
